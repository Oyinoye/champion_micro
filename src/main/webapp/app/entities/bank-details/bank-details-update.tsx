  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="championApp.bankDetails.home.createOrEditLabel" data-cy="BankDetailsCreateUpdateHeading">
            <Translate contentKey="championApp.bankDetails.home.createOrEditLabel">Create or edit a BankDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
