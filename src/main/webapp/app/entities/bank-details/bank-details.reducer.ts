...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_BANKDETAILS: 'bankDetails/PARTIAL_UPDATE_BANKDETAILS',
...
export default (state: BankDetailsState = initialState, action): BankDetailsState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BANKDETAILS):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_BANKDETAILS):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_BANKDETAILS):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IBankDetails> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_BANKDETAILS,
