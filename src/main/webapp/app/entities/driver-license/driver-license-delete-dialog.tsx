...
export const DriverLicenseDeleteDialog = (props: IDriverLicenseDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="championApp.driverLicense.delete.question">
        <Translate contentKey="championApp.driverLicense.delete.question" interpolate={{ id: driverLicenseEntity.id }}>
