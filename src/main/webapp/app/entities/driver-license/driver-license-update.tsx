  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="championApp.driverLicense.home.createOrEditLabel" data-cy="DriverLicenseCreateUpdateHeading">
            <Translate contentKey="championApp.driverLicense.home.createOrEditLabel">Create or edit a DriverLicense</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : driverLicenseEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="driver-license-champion" data-cy="champion" type="select" className="form-control" name="championId">
                  <option value="" key="0" />
                  {champions
