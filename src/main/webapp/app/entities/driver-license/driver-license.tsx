  ...
  return (
    <div>
      <h2 id="driver-license-heading" data-cy="DriverLicenseHeading">
        <Translate contentKey="championApp.driverLicense.home.title">Driver Licenses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="championApp.driverLicense.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="championApp.driverLicense.home.createLabel">Create new Driver License</Translate>
          </Link>
        </div>
      </h2>
        ...
        {driverLicenseList && driverLicenseList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="championApp.driverLicense.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.driverLicense.licenseNumber">License Number</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.driverLicense.issueDate">Issue Date</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.driverLicense.expiryDate">Expiry Date</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.driverLicense.address">Address</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.driverLicense.comment">Comment</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.driverLicense.champion">Champion</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="championApp.driverLicense.home.notFound">No Driver Licenses found</Translate>
            </div>
          )
        )}
      </div>
