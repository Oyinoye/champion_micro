  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="championApp.guarantor.home.createOrEditLabel" data-cy="GuarantorCreateUpdateHeading">
            <Translate contentKey="championApp.guarantor.home.createOrEditLabel">Create or edit a Guarantor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : guarantorEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="guarantor-champion" data-cy="champion" type="select" className="form-control" name="championId">
                  <option value="" key="0" />
                  {champions
