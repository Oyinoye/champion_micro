  ...
  return (
    <div>
      <h2 id="guarantor-heading" data-cy="GuarantorHeading">
        <Translate contentKey="championApp.guarantor.home.title">Guarantors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="championApp.guarantor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="championApp.guarantor.home.createLabel">Create new Guarantor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {guarantorList && guarantorList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="championApp.guarantor.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.firstName">First Name</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.lastName">Last Name</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.dateOfBirth">Date Of Birth</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.relationship">Relationship</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.knowHowLong">Know How Long</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.occupation">Occupation</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.homeAddress">Home Address</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.officeAddress">Office Address</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.utilityUpload">Utility Upload</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.idUpload">Id Upload</Translate>
                </th>
                <th>
                  <Translate contentKey="championApp.guarantor.champion">Champion</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="championApp.guarantor.home.notFound">No Guarantors found</Translate>
            </div>
          )
        )}
      </div>
