  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="championApp.platform.home.createOrEditLabel" data-cy="PlatformCreateUpdateHeading">
            <Translate contentKey="championApp.platform.home.createOrEditLabel">Create or edit a Platform</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
