  ...
  return (
    <div>
      <h2 id="platform-heading" data-cy="PlatformHeading">
        <Translate contentKey="championApp.platform.home.title">Platforms</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="championApp.platform.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="championApp.platform.home.createLabel">Create new Platform</Translate>
          </Link>
        </div>
      </h2>
        ...
        {platformList && platformList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="championApp.platform.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="championApp.platform.home.notFound">No Platforms found</Translate>
            </div>
          )
        )}
      </div>
