...
export class BankDetailsDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('championApp.bankDetails.delete.question'));
...
export default class BankDetailsComponentsPage {
  ...
  async deleteBankDetails() {
    ...
    expect(await bankDetailsDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/championApp.bankDetails.delete.question/);
