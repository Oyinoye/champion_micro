...
export class DriverLicenseDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('championApp.driverLicense.delete.question'));
...
export default class DriverLicenseComponentsPage {
  ...
  async deleteDriverLicense() {
    ...
    expect(await driverLicenseDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/championApp.driverLicense.delete.question/);
