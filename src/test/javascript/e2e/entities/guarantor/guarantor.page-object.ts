...
export class GuarantorDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('championApp.guarantor.delete.question'));
...
export default class GuarantorComponentsPage {
  ...
  async deleteGuarantor() {
    ...
    expect(await guarantorDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/championApp.guarantor.delete.question/);
