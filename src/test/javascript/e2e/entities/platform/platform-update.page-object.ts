...
export default class PlatformUpdatePage {
  pageTitle: ElementFinder = element(by.id('championApp.platform.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  codeInput: ElementFinder = element(by.css('input#platform-code'));
  descriptionInput: ElementFinder = element(by.css('input#platform-description'));
