...
export class PlatformDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('championApp.platform.delete.question'));
...
export default class PlatformComponentsPage {
  ...
  async deletePlatform() {
    ...
    expect(await platformDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/championApp.platform.delete.question/);
